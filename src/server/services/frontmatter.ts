 ...
 * The single source of truth (in `@shared/properties`) shared by filtering, operations, and the
 * client; re-exported here for the existing server-side imports.
 */
export { isEmptyPropertyValue } from '@shared/properties'
