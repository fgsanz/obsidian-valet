...
async function listDocs(): Promise<DocPage[]> {
  ...
  const KNOWN_ORDER = ['index', 'getting-started', 'vaults', 'operations', 'filters', 'frontmatter-types', 'obsidian-scenarios', 'git-setup', 'git-integration', 'without-git-integration', 'git-cloud-storage', 'operation-rollback', 'npm-scripts', 'testing', 'test-vault', 'test-cases', 'releases', 'changelog', 'support']
